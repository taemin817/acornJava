...
public class 김병진_Order {
	...
	김병진_Item[] item = new 김병진_Item[NUM]; //등록된 상품목록
	김병진_Order[] orderList = new 김병진_Order[MAX_ORDER]; //주문서 저장
	...
	public int buyItem(String userId) {
		...
		김병진_Order newOrder = new 김병진_Order();
		newOrder.id = userId;
		newOrder.name = name;
